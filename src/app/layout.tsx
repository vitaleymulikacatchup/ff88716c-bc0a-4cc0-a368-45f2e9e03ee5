...
export const metadata: Metadata = {
  title: "Fresh Bakery Ukraine - Artisan Bread & Pastries Daily",
  description: "Traditional Ukrainian bakery crafting fresh bread, pastries & custom cakes daily. Local family business using authentic recipes & premium ingredients.",
  keywords: "Ukrainian bakery, fresh bread, artisan pastries, custom cakes, local bakery, traditional recipes, organic ingredients",
  openGraph: {
    title: "Fresh Bakery Ukraine - Artisan Bread & Pastries Daily",
    description: "Traditional Ukrainian bakery crafting fresh bread, pastries & custom cakes daily using authentic family recipes.",
    siteName: "Fresh Bakery",
    type: "website",
    images: [
      {
        url: "https://images.pexels.com/photos/16521891/pexels-photo-16521891.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
        alt: "Fresh baked bread and pastries display"
      }
    ]
  },
  twitter: {
    card: "summary_large_image",
    title: "Fresh Bakery Ukraine - Artisan Bread & Pastries",
    description: "Traditional Ukrainian bakery with fresh daily baking using authentic family recipes",
    images: ["https://images.pexels.com/photos/16521891/pexels-photo-16521891.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
